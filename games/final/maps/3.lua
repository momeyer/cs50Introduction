return {
  ...
  layers = {
    ...
    },
    {
      ...
      encoding = "base64",
      compression = "zlib",
      data = "eJzt07kNgDAQRNEB2wH0R/WcBjKuEuBLroAIEPull2y0yUiWda/aSw1adOgxIGLEhBknFKQMeXj663dU+cSy/t7ipBUbdhwu3Qv2UdpGLOvTXcqXD3Y="
    },
    {
      type = "tilelayer",
      x = 0,
      ...
      encoding = "base64",
      compression = "zlib",
      data = "eJxjYBgFo2AUjIJRQE3wj4OB4T8aZuAcaFdBgAzQHbJoWG6QuK0M6I5yNFwxSNw2BeiOqWh42qjbCIJRt5EHNgHdsRkNbxkkbiMGAAAy8BxI"
    },
    {
      type = "objectgroup",
      draworder = "topdown",
